(() => {
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", function(t) {
            ...
            function S() {
                var t;
                var e = A(j.files).reduce(function(t, e) {
                    return t + e.size
                }, 0);
            ...
            var o = {
                ...
                track_player: function t() {
                    ...
                    if (typeof Plyr !== "undefined") {
                        ...
                        var s = new Plyr(this.player_DOM, {
                            ...
                            listeners: bt({}, u.isRequiredPercentage() && {
                                seek: function t(e) {
                ...
                disable_complete_lesson_btn: function t() {
                    ...
                    if (i < o) {
                        ...
                        a.wrap('<div class="tooltip-wrap"></div>').after('<span class="tooltip-txt tooltip-bottom">'.concat(gt(d("Watch at least %s% to complete the lesson.", "tutor"), e.required_percentage), "</span>"))
                    }
                },
