(function($) {
    ...
    if ($('#edupls-shop-view-mode li').length) {
        $('#edupls-shop-view-mode li').on('click', function() {
            $('body').removeClass('edupls-product-grid-view').removeClass('edupls-product-list-view');

            if ($(this).hasClass('edupls-shop-list')) {
                $('body').addClass('edupls-product-list-view');
                Cookies.set('edupls-shop-view', 'list');
            } else {
                $('body').addClass('edupls-product-grid-view');
                Cookies.remove('edupls-shop-view');
            }
            return false;
        });
    }
